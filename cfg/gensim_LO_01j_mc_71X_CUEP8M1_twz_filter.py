...
# with command line options: Configuration/GenProduction/python/pythiaFragmentCUEP8M1_LO_01j.py --fileout GENSIM_71X.root --mc --eventcontent RAWSIM,LHE --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step LHE,GEN,SIM --magField 38T_PostLS1 --python_filename tmp.py --no_exec -n options.maxEvents
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/pythiaFragmentCUEP8M1_LO_01j.py nevts:%i'%options.maxEvents),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GENSIM_71X.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GENSIM_71X_inLHE.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),

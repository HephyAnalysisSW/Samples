...
# with command line options: NANO -s NANO --data --fileout=nano_data_UL20_2016 --conditions 106X_dataRun2_v35 --era Run2_2016,run2_nanoAOD_106Xv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2016F/DoubleMuon/MINIAOD/UL2016_MiniAODv2-v1/140000/33803554-7C65-C842-969E-864505D95ED5.root'),

...
# with command line options: NANO -s NANO --data --fileout=nano_data_UL20_2017 --conditions 106X_dataRun2_v35 --era Run2_2017,run2_nanoAOD_106Xv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017B/DoubleMuon/MINIAOD/UL2017_MiniAODv2-v1/260000/00D2FD3A-35D0-C648-A225-5B70823C8184.root'),

...
config.General.workArea = 'crab_hlt_%s' % tag
config.General.transferLogs = True

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../../cfg/hlt_mc_UL18.py'
...
if __name__ == '__main__':
    ...
    for input_dataset in [
        '/TTTT_MS_EFTdecay/schoef-22-05-12-a03b32ff24c52459822077d23898e252/USER',
        '/TTbb_MS_EFT/schoef-22-05-12-a03b32ff24c52459822077d23898e252/USER',
    ]:
